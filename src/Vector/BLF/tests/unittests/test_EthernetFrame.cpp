...
BOOST_AUTO_TEST_CASE(EthernetFrame_7a5d95c7e63f268ca2d7492c2201b805) {
    ...
    {
        0x01, 0x80, 0xc2, 0x00, 0x00, 0x0e, 0x02, 0x7d,
        0xfa, 0x00, 0x10, 0x02, 0x88, 0xf7, 0x10, 0x02,
        0x00, 0x2c, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x02, 0x7d, 0xfa, 0xff, 0xfe, 0x00,
        0x10, 0x02, 0x00, 0x05, 0x55, 0x90, 0x00, 0xfb,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00
    };
...
BOOST_AUTO_TEST_CASE(EthernetFrame_96f6b7bd1df9c40b778a4bb867130b8f) {
    ...
    const std::vector<uint8_t> expectedPayLoad =
    {
        
    };
    BOOST_CHECK_EQUAL_COLLECTIONS(obj->payLoad.cbegin(), obj->payLoad.cend(), expectedPayLoad.cbegin(), expectedPayLoad.cend());
    delete obj;
}
...
BOOST_AUTO_TEST_CASE(EthernetFrame_ab35e16512387c0782a690651d22d05c) {
    ...
    const std::vector<uint8_t> expectedPayLoad =
    {
        0x33, 0x33, 0x00, 0x00, 0x00, 0x02, 0x02, 0x7d,
        0xfa, 0x00, 0x10, 0x00, 0x81, 0x00, 0x80, 0x02,
        0x86, 0xdd, 0x60, 0x00, 0x00, 0x00, 0x00, 0x18,
        0x11, 0xff, 0xfd, 0x53, 0x7c, 0xb8, 0x03, 0x83,
        0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x10, 0xff, 0x14, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x02, 0xa7, 0xf2, 0xa6, 0x3d, 0x00, 0x18,
        0xfc, 0x6b, 0x00, 0x00, 0x00, 0x61, 0x00, 0x00,
        0x00, 0x08, 0x00, 0x00, 0x38, 0x00, 0x00, 0x01,
        0x00, 0x00
    };
    BOOST_CHECK_EQUAL_COLLECTIONS(obj->payLoad.cbegin(), obj->payLoad.cend(), expectedPayLoad.cbegin(), expectedPayLoad.cend());
    delete obj;
