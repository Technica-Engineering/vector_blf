...
BOOST_AUTO_TEST_CASE(LinSchedulerModeChange)
{
    ...
    Vector::BLF::LinSchedulerModeChange * obj = static_cast<Vector::BLF::LinSchedulerModeChange *>(ohb);
    ...
    BOOST_CHECK(obj->objectType == Vector::BLF::ObjectType::LIN_SCHED_MODCH);
