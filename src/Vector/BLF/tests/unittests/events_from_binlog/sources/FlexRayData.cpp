...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_FlexRayData.blf");
    ...
    /* define object */
    VBLFLEXRAYData obj;
    memset(&obj, 0, sizeof(VBLFLEXRAYData));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLFLEXRAYData);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_FLEXRAY_DATA;
