...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_MostNetState.blf");
    ...
    /* define object */
    VBLMOSTNetState obj;
    memset(&obj, 0, sizeof(VBLMOSTNetState));

    /* VBLMOSTNetState */
    obj.mChannel = 0x1111;
    obj.mStateNew = 0x2222;
    obj.mStateOld = 0x3333;
    obj.mDummy1 = 0x4444;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOSTNetState);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_NETSTATE;
