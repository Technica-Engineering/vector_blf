...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_LinDlcInfo.blf");
    ...
    /* define object */
    VBLLINDLCInfo obj;
    memset(&obj, 0, sizeof(VBLLINDLCInfo));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLLINDLCInfo);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_LIN_DLC_INFO;
