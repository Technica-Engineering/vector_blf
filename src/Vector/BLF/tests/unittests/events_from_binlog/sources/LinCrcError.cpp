...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_LinCrcError.blf");
    ...
    /* define object */
    VBLLINCRCError obj;
    memset(&obj, 0, sizeof(VBLLINCRCError));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLLINCRCError);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_LIN_CRC_ERROR;
