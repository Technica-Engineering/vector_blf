...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_LinBaudrateEvent.blf");
    ...
    /* define object */
    VBLLINBaudrateEvent obj;
    memset(&obj, 0, sizeof(VBLLINBaudrateEvent));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLLINBaudrateEvent);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_LIN_BAUDRATE;
