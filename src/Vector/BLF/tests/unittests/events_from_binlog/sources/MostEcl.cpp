...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_MostEcl.blf");
    ...
    /* define object */
    VBLMOSTEcl obj;
    memset(&obj, 0, sizeof(VBLMOSTEcl));

    /* VBLMOSTEcl */
    obj.mChannel = 0x1111;
    obj.mMode = 0x2222;
    obj.mEclState = 0x3333;
    obj.mDummy2 = 0x4444;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOSTEcl);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_ECL;
