...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_AppText.blf");
    ...
    /* define object */
    VBLAppText obj;
    memset(&obj, 0, sizeof(VBLAppText));

    /* VBLAppText */
    obj.mSource = BL_APPTEXT_METADATA;
    obj.mReserved = 0;
    obj.mText = "xyz";
    obj.mTextLength = 3;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLAppText) + obj.mTextLength;
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_APP_TEXT;
