...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_Most150MessageFragment.blf");
    ...
    /* define object */
    VBLMOST150MessageFragment obj;
    memset(&obj, 0, sizeof(VBLMOST150MessageFragment));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOST150MessageFragment) + obj.mFirstDataLen;
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_150_MESSAGE_FRAGMENT;
