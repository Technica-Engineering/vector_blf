...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_EventComment.blf");
    ...
    /* define object */
    VBLEventComment obj;
    memset(&obj, 0, sizeof(VBLEventComment));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLEventComment) + obj.mTextLength;
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_EVENT_COMMENT;
