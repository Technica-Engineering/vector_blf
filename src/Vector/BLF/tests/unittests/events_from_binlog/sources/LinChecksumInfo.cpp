...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_LinChecksumInfo.blf");
    ...
    /* define object */
    VBLLINChecksumInfo obj;
    memset(&obj, 0, sizeof(VBLLINChecksumInfo));

    /* VBLLINChecksumInfo */
    obj.mChannel = 0x1111;
    obj.mID = 0x22;
    obj.mChecksumModel = 0x33;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLLINChecksumInfo);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_LIN_CHECKSUM_INFO;
