...
int main(int argc, char ** argv) {
    ...
    /* define object */
    VBLEthernetErrorEx obj;
    memset(&obj, 0, sizeof(VBLEthernetErrorEx));

    /* VBLEthernetErrorEx */
    obj.mStructLength = sizeof(VBLEthernetErrorEx) - sizeof(VBLObjectHeader) - sizeof(obj.mStructLength) - sizeof(obj.mFrameData);
    obj.mFlags = 0x1111;
    obj.mChannel = 0x2222;
    ...
    obj.mHeader.mBase.mObjectSize = offsetof(VBLEthernetErrorEx, mFrameData) + obj.mFrameLength;
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_ETHERNET_ERROR_EX;
