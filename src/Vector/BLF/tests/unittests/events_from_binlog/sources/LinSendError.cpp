...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_LinSendError.blf");
    ...
    /* define object */
    VBLLINSendError obj;
    memset(&obj, 0, sizeof(VBLLINSendError));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLLINSendError);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_LIN_SND_ERROR;
