...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_MostStatisticEx.blf");
    ...
    /* define object */
    VBLMOSTStatisticEx obj;
    memset(&obj, 0, sizeof(VBLMOSTStatisticEx));

    /* VBLMOSTStatisticEx */
    obj.mChannel = 0x1111;
    obj.mDummy1 = 0x2222;
    obj.mCodingErrors = 0x33333333;
    obj.mFrameCounter = 0x44444444;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOSTStatisticEx);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_STATISTICEX;
