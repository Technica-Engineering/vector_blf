...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_MostStatistic.blf");
    ...
    /* define object */
    VBLMOSTStatistic obj;
    memset(&obj, 0, sizeof(VBLMOSTStatistic));

    /* VBLMOSTStatistic */
    obj.mChannel = 0x1111;
    obj.mPktCnt = 0x2222;
    obj.mFrmCnt = 0x33333333;
    obj.mLightCnt = 0x44444444;
    obj.mBufferLevel = 0x55555555;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOSTStatistic);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_STATISTIC;
