...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_MostStress.blf");
    ...
    /* define object */
    VBLMOSTStress obj;
    memset(&obj, 0, sizeof(VBLMOSTStress));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOSTStress);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_STRESS;
