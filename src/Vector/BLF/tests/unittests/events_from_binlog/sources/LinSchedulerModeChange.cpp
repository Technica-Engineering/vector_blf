...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_LinSchedulerModeChange.blf");
    ...
    /* define object */
    VBLLINSchedulerModeChange obj;
    memset(&obj, 0, sizeof(VBLLINSchedulerModeChange));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLLINSchedulerModeChange);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_LIN_SCHED_MODCH;
