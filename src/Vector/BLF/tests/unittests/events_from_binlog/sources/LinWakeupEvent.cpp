...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_LinWakeupEvent.blf");
    ...
    /* define object */
    VBLLINWakeupEvent obj;
    memset(&obj, 0, sizeof(VBLLINWakeupEvent));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLLINWakeupEvent);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_LIN_WAKEUP;
