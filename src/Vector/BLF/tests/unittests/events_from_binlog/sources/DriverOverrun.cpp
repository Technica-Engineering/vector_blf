...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_DriverOverrun.blf");
    ...
    /* define object */
    VBLDriverOverrun obj;
    memset(&obj, 0, sizeof(VBLDriverOverrun));

    /* VBLDriverOverrun */
    obj.mBusType = 0x00000001;
    obj.mChannel = 0x2222;
    obj.mDummy = 0x3333;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLDriverOverrun);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_OVERRUN_ERROR;
