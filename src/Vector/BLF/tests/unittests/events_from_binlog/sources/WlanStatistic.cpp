...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_WlanStatistic.blf");
    ...
    /* define object */
    VBLWlanStatistic obj;
    memset(&obj, 0, sizeof(VBLWlanStatistic));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLWlanStatistic);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_WLAN_STATISTIC;
