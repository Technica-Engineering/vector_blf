...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_MostTxLight.blf");
    ...
    /* define object */
    VBLMOSTTxLight obj;
    memset(&obj, 0, sizeof(VBLMOSTTxLight));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOSTTxLight);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_TXLIGHT;
