...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_CanDriverHwSync.blf");
    ...
    /* define object */
    VBLCANDriverHwSync obj;
    memset(&obj, 0, sizeof(VBLCANDriverHwSync));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLCANDriverHwSync);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_CAN_DRIVER_SYNC;
