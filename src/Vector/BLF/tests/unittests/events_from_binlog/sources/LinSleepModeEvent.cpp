...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_LinSleepModeEvent.blf");
    ...
    /* define object */
    VBLLINSleepModeEvent obj;
    memset(&obj, 0, sizeof(VBLLINSleepModeEvent));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLLINSleepModeEvent);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_LIN_SLEEP;
