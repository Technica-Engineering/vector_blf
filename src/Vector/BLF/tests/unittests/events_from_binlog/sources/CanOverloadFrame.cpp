...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_CanOverloadFrame.blf");
    ...
    /* define object */
    VBLCANOverloadFrame obj;
    memset(&obj, 0, sizeof(VBLCANOverloadFrame));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLCANOverloadFrame);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_CAN_OVERLOAD;
