...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_MostCtrl.blf");
    ...
    /* define object */
    VBLMOSTCtrl obj;
    memset(&obj, 0, sizeof(VBLMOSTCtrl));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOSTCtrl);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_CTRL;
