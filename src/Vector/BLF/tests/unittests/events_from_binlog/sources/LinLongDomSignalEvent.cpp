...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_LinLongDomSignalEvent.blf");
    ...
    /* define object */
    VBLLINLongDomSignalEvent obj;
    memset(&obj, 0, sizeof(VBLLINLongDomSignalEvent));

    /* VBLLINLongDomSignalEvent */
    obj.mType = 0x11;
    obj.mReserved[0] = 0x22;
    obj.mReserved[1] = 0x22;
    obj.mReserved[2] = 0x22;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLLINLongDomSignalEvent);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_LIN_LONG_DOM_SIG;
