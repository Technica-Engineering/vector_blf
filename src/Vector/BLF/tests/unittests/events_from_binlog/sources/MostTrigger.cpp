...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_MostTrigger.blf");
    ...
    /* define object */
    VBLMOSTTrigger obj;
    memset(&obj, 0, sizeof(VBLMOSTTrigger));
    ...
    obj.mMode = 0x3333;
    obj.mHW = 0x4444;
    obj.mPreviousTriggerValue = 0x55555555;
    obj.mCurrentTriggerValue = 0x66666666;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOSTTrigger);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_TRIGGER;
