...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_EthernetFrameForwarded.blf");
    ...
    /* define object */
    VBLEthernetFrameForwarded obj;
    memset(&obj, 0, sizeof(VBLEthernetFrameForwarded));

    /* VBLEthernetFrameForwarded */
    obj.mStructLength = sizeof(VBLEthernetFrameForwarded) - sizeof(VBLObjectHeader) - sizeof(obj.mStructLength) - sizeof(obj.mFrameData);
    obj.mFlags = 0x1111;
    obj.mChannel = 0x2222;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLEthernetFrame) + obj.mFrameLength;
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_ETHERNET_FRAME_FORWARDED;
