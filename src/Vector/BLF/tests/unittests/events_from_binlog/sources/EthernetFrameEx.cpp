...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_EthernetFrameEx.blf");
    ...
    /* define object */
    VBLEthernetFrameEx obj;
    memset(&obj, 0, sizeof(VBLEthernetFrameEx));

    /* VBLEthernetFrameEx */
    obj.mStructLength = sizeof(VBLEthernetFrameEx) - sizeof(VBLObjectHeader) - sizeof(obj.mStructLength) - sizeof(obj.mFrameData);
    obj.mFlags = 0x1111;
    obj.mChannel = 0x2222;
    ...
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_ETHERNET_FRAME_EX;
