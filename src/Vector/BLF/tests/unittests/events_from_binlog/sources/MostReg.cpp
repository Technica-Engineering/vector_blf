...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_MostReg.blf");
    ...
    /* define object */
    VBLMOSTReg obj;
    memset(&obj, 0, sizeof(VBLMOSTReg));
    ...
    obj.mOffset = 0x55555555;
    obj.mChip = 0x6666;
    obj.mRegDataLen = 0x7777;
    for (BYTE i = 0; i < 16; i++)
        obj.mRegData[i] = i;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOSTReg);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_REG;
