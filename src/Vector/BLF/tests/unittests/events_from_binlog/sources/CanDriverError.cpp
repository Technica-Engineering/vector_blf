...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_CanDriverError.blf");
    ...
    /* define object */
    VBLCANDriverError obj;
    memset(&obj, 0, sizeof(VBLCANDriverError));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLCANDriverError);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_CAN_DRIVER_ERROR;
