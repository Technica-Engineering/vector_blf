...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_MostLightLock.blf");
    ...
    /* define object */
    VBLMOSTLightLock obj;
    memset(&obj, 0, sizeof(VBLMOSTLightLock));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOSTLightLock);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_LIGHTLOCK;
