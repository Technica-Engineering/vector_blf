...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_Most50Pkt.blf");
    ...
    /* define object */
    VBLMOST50Pkt obj;
    memset(&obj, 0, sizeof(VBLMOST50Pkt));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOST50Pkt) + obj.mPktDataLength;
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_50_PKT;
