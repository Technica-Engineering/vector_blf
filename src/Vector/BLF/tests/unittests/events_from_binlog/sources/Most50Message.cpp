...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_Most50Message.blf");
    ...
    /* define object */
    VBLMOST50Message obj;
    memset(&obj, 0, sizeof(VBLMOST50Message));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOST50Message) + obj.mMsgLen;
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_50_MESSAGE;
