...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_LinSlaveTimeout.blf");
    ...
    /* define object */
    VBLLINSlaveTimeout obj;
    memset(&obj, 0, sizeof(VBLLINSlaveTimeout));

    /* VBLLINSlaveTimeout */
    obj.mChannel = 0x1111;
    obj.mSlaveID = 0x22;
    obj.mStateID = 0x33;
    obj.mFollowStateID = 0x44444444;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLLINSlaveTimeout);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_LIN_SLV_TIMEOUT;
