...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_Most150AllocTab.blf");
    ...
    /* define object */
    VBLMOST150AllocTab obj;
    memset(&obj, 0, sizeof(VBLMOST150AllocTab));

    /* VBLMOST150AllocTab */
    obj.mChannel = 0x1111;
    obj.mEventModeFlags = 0x2222;
    obj.mFreeBytes = 0x3333;
    obj.mLength = 3;
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLMOST150AllocTab) + obj.mLength;
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_MOST_150_ALLOCTAB;
