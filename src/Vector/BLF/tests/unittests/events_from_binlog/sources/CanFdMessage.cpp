...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_CanFdMessage.blf");
    ...
    /* define object */
    VBLCANFDMessage obj;
    memset(&obj, 0, sizeof(VBLCANFDMessage));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLCANFDMessage);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_CAN_FD_MESSAGE;
