...
int main(int argc, char ** argv) {
    /* create file */
    LPCTSTR pFileName = _T("test_CanErrorFrame.blf");
    ...
    /* define object */
    VBLCANErrorFrame obj;
    memset(&obj, 0, sizeof(VBLCANErrorFrame));
    ...
    obj.mHeader.mBase.mObjectSize = sizeof(VBLCANErrorFrame);
    obj.mHeader.mBase.mObjectType = BL_OBJ_TYPE_CAN_ERROR;
