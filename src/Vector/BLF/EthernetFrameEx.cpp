...
std::vector<uint8_t>::iterator EthernetFrameEx::fromData(std::vector<uint8_t>::iterator it) {
...
void EthernetFrameEx::toData(std::vector<uint8_t> & data) {
    /* pre processing */
    ...
    data.push_back((reservedEthernetFrameEx >>  0) & 0xff);
    data.push_back((reservedEthernetFrameEx >>  8) & 0xff);
    data.push_back((reservedEthernetFrameEx >> 16) & 0xff);
    data.push_back((reservedEthernetFrameEx >> 24) & 0xff);
