...
std::vector<uint8_t>::iterator Most150MessageFragment::fromData(std::vector<uint8_t>::iterator it) {
...
void Most150MessageFragment::toData(std::vector<uint8_t> & data) {
    /* pre processing */
    ...
    data.push_back((reservedMost150MessageFragment1 >>  0) & 0xff);
    ...
    data.push_back((reservedMost150MessageFragment2 >>  0) & 0xff);
    data.push_back((reservedMost150MessageFragment2 >>  8) & 0xff);
    data.push_back((reservedMost150MessageFragment2 >> 16) & 0xff);
    data.push_back((reservedMost150MessageFragment2 >> 24) & 0xff);
